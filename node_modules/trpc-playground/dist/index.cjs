...
__export(src_exports, {
  getInputFromInputParsers: () => getInputFromInputParsers,
  resolveConfig: () => resolveConfig,
  zodResolveTypes: () => zodResolveTypes
});
...
var resolveConfig = (config) => {
  const resolvedConfig = import_lodash.default.merge({}, getDefaultConfig(), config);
